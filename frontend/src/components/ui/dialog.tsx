...
>(({ className, ...props }, ref) => {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:pointer-events-none fixed inset-0 z-50 bg-black/50 backdrop-blur-sm transition-all duration-300",
        className,
      )}
      {...props}
    />
